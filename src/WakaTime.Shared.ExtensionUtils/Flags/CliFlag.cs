namespace WakaTime.Shared.ExtensionUtils.Flags
{
    internal class CliFlag : ICliFlag
    {
        ...
        internal CliFlag(string flag) => Flag = flag;
        ...
        /// <inheritdoc />
        public virtual string[] GetFlagWithValue() => new[] { Flag };
    ...
    internal class CliFlag<T> : CliFlag
    {
        ...
        private readonly string _alternateFlag;
        private readonly bool _alternateTakesPriority;
        ...
        internal CliFlag(string flag, T value) : this(flag, null, value, false)
        {
        }

        internal CliFlag(string flag, string alternateFlag, T value, bool alternateTakesPriority = true) : base(flag)
        {
            _alternateFlag = alternateFlag;
            _value = value;
            _alternateTakesPriority = alternateTakesPriority;
        }
        ...
        /// <inheritdoc />
        public override string[] GetFlagWithValue() => new[] { Flag, _value.ToString() };

        /// <inheritdoc />
        public override string ToString() => $"{Flag} {_value}";
