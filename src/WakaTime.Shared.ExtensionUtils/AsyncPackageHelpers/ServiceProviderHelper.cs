...
namespace WakaTime.Shared.ExtensionUtils.AsyncPackageHelpers
{
    public static class ServiceProviderHelper
    {
        ...
        public static async Task<T> GetServiceAsync<T>(IAsyncServiceProvider asyncServiceProvider, Type serviceType) where T : class
        {
            T returnValue = null;
        ...
        public static bool IsAsyncPackageSupported(IServiceProvider serviceProvider)
        {
